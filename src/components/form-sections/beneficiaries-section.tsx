  ...
  return (
    <Card className="border-2 border-black">
      <CardHeader className="bg-gray-100">
        <CardTitle className="text-center font-bold">BENEFICIARIES INFORMATION</CardTitle>
      </CardHeader>
      <CardContent className="p-6">
        <div className="space-y-4">
          ...
          <Button
            type="button"
            variant="outline"
            onClick={() => appendBeneficiary({ name: "", birthDate: undefined, age: "", relationship: "" })}
          ...
          <div className="mt-4 grid grid-cols-5 gap-2 font-bold border-t pt-2">
            <div>Total Beneficiaries: {beneficiaryFields.length}</div>
            <div></div>
            <div></div>
            <div></div>
            <div></div>
